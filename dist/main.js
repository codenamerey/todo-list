...
const toDoList = (function() {
    ...
    const addProject = function(name) {
        console.log('I am in');
        let project_temp = new _project__WEBPACK_IMPORTED_MODULE_1__["default"](name);
